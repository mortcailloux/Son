...
struct mydsp : public dsp {
	...
	virtual void instanceConstants(int sample_rate) {
		...
		fConst1 = std::tan(942.4778f / fConst0);
		fConst2 = mydsp_faustpower2_f(fConst1);
		fConst3 = 2.0f * (1.0f - 1.0f / fConst2);
		fConst4 = 1.0f / fConst1;
		fConst5 = (fConst4 + -0.618034f) / fConst1 + 1.0f;
		fConst6 = (fConst4 + 0.618034f) / fConst1 + 1.0f;
		fConst7 = 1.0f / fConst6;
		fConst8 = (fConst4 + -1.618034f) / fConst1 + 1.0f;
		fConst9 = (fConst4 + 1.618034f) / fConst1 + 1.0f;
		...
		fConst14 = (fConst13 + -0.618034f) / fConst11 + 1.0f;
		fConst15 = (fConst13 + 0.618034f) / fConst11 + 1.0f;
		fConst16 = 1.0f / fConst15;
		fConst17 = (fConst13 + -1.618034f) / fConst11 + 1.0f;
		fConst18 = 1.0f / ((fConst13 + 1.618034f) / fConst11 + 1.0f);
		fConst19 = 1.0f - fConst13;
		fConst20 = 1.0f / (fConst13 + 1.0f);
		fConst21 = 1.0f / (fConst1 * fConst15);
		fConst22 = 1.0f - fConst4;
		fConst23 = 1.0f / (fConst4 + 1.0f);
		fConst24 = 1.0f / (fConst2 * fConst9);
		fConst25 = 0.02f / (fConst2 * fConst6);
...
vinyle::vinyle() : AudioStream(FAUST_INPUTS, new audio_block_t*[FAUST_INPUTS])
{
#ifdef NVOICES
    int nvoices = NVOICES;
...
void vinyle::update(void) { updateImp<FAUST_INPUTS, FAUST_OUTPUTS>(); }

void vinyle::setParamValue(const std::string& path, float value)
{
    fUI->setParamValue(path, value);
}

float vinyle::getParamValue(const std::string& path)
{
